...
class Decoder(nn.Module):
  def __init__(self, hidden_channels, filter_channels, n_heads, n_layers, kernel_size=1, p_dropout=0., proximal_bias=False, proximal_init=True, **kwargs):
    ...
    self.norm_layers_2 = nn.ModuleList()
    for i in range(self.n_layers):
      self.self_attn_layers.append(MultiHeadDiffAttention(hidden_channels, hidden_channels, n_heads, i+1, p_dropout=p_dropout, proximal_bias=proximal_bias, proximal_init=proximal_init))
      self.norm_layers_0.append(LayerNorm(hidden_channels))
      self.encdec_attn_layers.append(MultiHeadDiffAttention(hidden_channels, hidden_channels, n_heads, i+1, p_dropout=p_dropout))
      self.norm_layers_1.append(LayerNorm(hidden_channels))
